(function () {
  ...
  const dictionaries = {
    "zh-Hant": {
      ...
      "admin.studentData": "學生資料（選填）", "admin.dataPlaceholder": "座號\t姓名\t外號\t帳號\t密碼\t居住地點\n1\t王小明\t小明\tstudent01\t••••••\t臺北市", "admin.dataHelp": "第一列填欄名，可直接貼上 Excel；姓名後方可增加任意資料欄位。", "admin.dataPrivacy": "資料會在展示模式點擊學生卡牌後顯示；密碼類欄位預設遮罩，請仍避免輸入不應公開的敏感資訊。",
    ...
    en: {
      ...
      "admin.studentData": "Student data (optional)", "admin.dataPlaceholder": "Number\tName\tNickname\tAccount\tPassword\tLocation\n1\tAlex Chen\tAlex\tstudent01\t••••••\tTaipei", "admin.dataHelp": "Use the first row for field names, then paste directly from Excel. Add any columns after the student name.", "admin.dataPrivacy": "These fields appear when a student card is opened in presentation mode. Password fields are masked by default; avoid entering information that should not be shown publicly.",
