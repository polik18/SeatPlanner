(function () {
  ...
  const dictionaries = {
    ...
    en: {
      ...
      "admin.space": "ROOM LAYOUT", "admin.grid": "Seat Grid", "admin.columns": "Columns", "admin.rows": "Rows", "admin.gridHelp": "Change rows or columns at any time. Existing positions keep their settings. Click a seat to cycle its state, use the top-right button to pin a student, or click an axis label for batch changes.", "admin.rotateLayout": "Rotate entire seating chart", "admin.rotateHelp": "Rotate 90° at a time while preserving seat rules, pins, and draw results.", "admin.rotateCounterclockwise": "90° counterclockwise", "admin.rotateClockwise": "90° clockwise", "admin.roomMarkers": "Room marker positions", "admin.roomMarkersHelp": "Place the board, door, and teacher seat anywhere around the room, or hide them.", "admin.boardPosition": "Board", "admin.doorPosition": "Door", "admin.teacherPosition": "Teacher seat", "admin.dataTools": "DATA TOOLS", "admin.backupReset": "Backup & Reset", "admin.export": "Export settings", "admin.import": "Import settings", "admin.clearPins": "Clear pins", "admin.reset": "Reset defaults",
